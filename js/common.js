$(document).ready(function () {
  ...
  $(".grid__item:not(:first)").on("click", function () {
    ...
    $.each(sertifArrFirst, function (index, value) {
      $(this)
        .find(".sertif-slider .sertif-slide__item")
        .append('<img src="" alt="">');
    ...
    $.each(sertifArr, function (index, value) {
      $(".grid__item:first")
        ...
        .append('<img src="" alt="">');
      $(".grid__item:first")
        .find(".sertif-slider .sertif-slide__item img")
        .attr("src", value);
      // console.log('Индекс: ' + index + '; Значение: ' + value);
    });
  ...
  /* ==================== ACCORDION ==================== */
  $("#accordion .accordion__wrap .accordion__head")
